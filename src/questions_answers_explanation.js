const questions = {
    ...
    fillInTheBlanks: [
        { question: "The three pillars of cybersecurity are ___, integrity, and availability.", answer: "Confidentiality" },
        { question: "A ___ is a program or code that spreads itself by replicating across systems without user intervention.", answer: "Worm" },
        { question: "In access control models, DAC stands for ___ Access Control.", answer: "Discretionary" },
        { question: "The process of converting readable data into an unreadable format to protect it is called ___.", answer: "Encryption" },
        { question: "___ is a method to verify the identity of a user or system before granting access.", answer: "Authentication" },
        { question: "A ___ attack attempts to overwhelm a service to make it unavailable to users.", answer: "DDoS (Distributed Denial of Service)" },
        { question: "In a ___ attack, an attacker manipulates input fields to execute arbitrary SQL code.", answer: "SQL Injection" },
        { question: "___ engineering exploits human behavior rather than system vulnerabilities.", answer: "Social" },
        { question: "A ___ is a type of malware that encrypts a user's files and demands payment.", answer: "Ransomware" },
        { question: "An attack that uses legitimate tools like PowerShell to avoid detection is known as a ___ attack.", answer: "Living-off-the-land" },
        { question: "In networking, a ___ isolates traffic between different segments for security.", answer: "VLAN (Virtual Local Area Network)" },
        { question: "A ___ point of failure is a component that can bring down an entire system if compromised.", answer: "Single" },
        { question: "The term ___ refers to vulnerabilities that are exploited before a vendor releases a patch.", answer: "Zero-Day" },
        { question: "The protocol ___ is commonly used to secure web traffic using encryption.", answer: "HTTPS (HyperText Transfer Protocol Secure)" },
        { question: "In cryptography, ___ ensures that a message cannot be changed without detection.", answer: "Integrity" },
        { question: "SCADA systems are commonly used in managing and monitoring ___ infrastructure such as power or water.", answer: "Critical" },
        { question: "In healthcare, security incidents can affect not only data but also ___ safety.", answer: "Patient" },
        { question: "One reason ICS systems are hard to secure is their limited ability to tolerate ___.", answer: "Downtime" },
        { question: "Biometric authentication systems use ___ traits like fingerprints or facial patterns.", answer: "Physiological" }
    ],
    matching: [
        {
